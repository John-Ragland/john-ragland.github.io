...
# Education
## **Auburn University**, Electrical Engineering
...
- **Thesis**: Digital Simulation and Recreation of a Vacuum Tube Guitar Amp [url](https://etd.auburn.edu//handle/10415/7112)

- **Advisor**: Thaddeus Roppel
...
- **Thesis**: Using coherent ambient sound to probe the ocean [url](https://hdl.handle.net/1773/51959)

- **Advisor**: Shima Abadi

- **Emphasis**: Acoustic Oceanography: Ambient noise interferometry and ocean acoustic tomography
...
- *Lead PI*: **John Ragland**; Woods Hole Oceanographic Institution

- *Co-PI*: John Colosi; Woods Hole Oceanographic Institution

- *Co-PI*: Brian Arbic; University of Michigan

- *Co-PI*: Yadidya Badarvada; Florida State University



## **Analysis and modeling for Task Force Ocean New England Seamounts Experiments**

ONR

2025 – 2027

- *PI*: John Colosi; Woods Hole Oceanographic Institution

- *Co-PI*: **John Ragland**; Woods Hole Oceanographic Institution
...
- *Collaborator*: **John Ragland**; helped develop project idea and collaborated on the research statement. Grant supported postdoctoral appointment at UW



# Community Service
- **Associate Editor** - [Proceedings of Meetings on Acoustics](https://pubs.aip.org/asa/poma), AIP, *Acoustic Oceanagraphy*
...
# Media Coverage
- [Listening to the ocean to measure the impact of climate change](https://web.archive.org/web/20230731211310/https://www.ece.uw.edu/spotlight/listening-to-the-ocean-climate-change/)
...
- **OOIPy** - python package for accessing OOI hydrophone data [GitHub](https://github.com/Ocean-Data-Lab/ooipy)[PyPI](https://pypi.org/project/ooipy/)[DOI](https://doi.org/10.5281/zenodo.4276861)

- **xrsignal** - python package that ports functionality from scipy.signal to xarray and is compatible with distributed computing [GitHub](https://github.com/John-Ragland/xrsignal) [PypI](https://pypi.org/project/xrsignal/)
